...
def double_auction_market(res_da_info, com_da_info, ind_da_info, carbon_intensity):
    ...
    res_reward = df[df.name == "res"].reward.values[0]
#     print('df: ', df)
    return res_reward
...
class ResidentialMicrogrid:
    ...
    def build_MG(self):
        ...
        with open('data/res_mg_1hour.pkl', "rb") as fmemg:
            self.generation_demand_1hour = pickle.load(fmemg)['2019-9-15':'2019-09-16 00:00:00	']
#         with open('data/res_14.pkl', "rb") as fmemg:
#             self.generation_demand_1hour = pickle.load(fmemg)['2014-5-15':'2014-5-16 00:00:00	']
